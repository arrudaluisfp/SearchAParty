...
class Estabelecimento2 extends StatefulWidget {
  @override
  _Estabelecimento2State createState() => _Estabelecimento2State();
}

class _Estabelecimento2State extends State<Estabelecimento2> {

  Firestore db = Firestore.instance;

  _body() {
    return StreamBuilder(
        stream: db.collection("estabelecimentos").document("002").snapshots(),
